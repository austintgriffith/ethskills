...
**You optimize for "works" and skip self-sovereignty.** A dApp can compile, pass tests, and still hand users to a censorable frontend, a closed indexer, an invisible RPC dependency, a custodial wallet, or an admin key with total control. Before coding, check whether the design preserves Ethereum's CROPS properties: Censorship Resistance, Open Source and Free (as in Freedom), Privacy, and Security.
...
|-------|-------------------|-----------------|
| **Plan** | CROPS gate, architecture, chain selection | `ship/` (this), `crops/`, `concepts/`, `l2s/`, `gas/`, `why/` |
