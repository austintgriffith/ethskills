...
| **CROPS Review** | `crops/SKILL.md` | For every dApp architecture plan, and for existing-system reviews involving trust assumptions, custody, admin powers, upgrades, hosted infra, privacy, identity, or user exit. |
