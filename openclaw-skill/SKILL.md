...
| **CROPS Review** | `crops/SKILL.md` | After the short CROPS Gate in `ship/SKILL.md` surfaces a real tradeoff (custody, admin powers, upgrades, hosted infra, identity, or agent permissions). |
